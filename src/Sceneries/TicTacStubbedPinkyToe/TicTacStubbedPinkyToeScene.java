...
public class TicTacStubbedPinkyToeScene implements Scenery {
    ...
    private String title = "TicTacStubbedPinkyToe";

    private String songPath = "resource/Music/SomewhereOnlyWeKnow-Keane.mp3";
    ...
    public TicTacStubbedPinkyToeScene(Stage primaryStage, Player player) {
        this.vBox = new VBox();
        this.hBox = new HBox();
        ...
        File milaFile = new File("resource/StubbedPinkyToe/Mila/mila.jpg");
        File ralfFile = new File("resource/StubbedPinkyToe/Ralf/Crappy PF.jpeg");
        try {
        ...
        this.buttonNextScene = new Button("Next scene");
        this.buttonNextScene.setOnAction(event -> {
        ...
        this.hBox.getChildren().addAll(this.buttonNextScene, this.buttonNewGame, this.buttonToggleImages, this.labelToggle);
