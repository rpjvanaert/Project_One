...
public class ToeLogic {
    ...
    private int checkDiagonal(){
        ...
        for (int x = 0; x < width - 4; ++x){
            for (int y = 0; y < height - 4; ++y){
                value = this.checkPlaces(new Point2D.Double(x,y), new Point2D.Double(x + 1,y + 1), new Point2D.Double(x + 2,y + 2), new Point2D.Double(x + 3,y + 3), new Point2D.Double(x + 4,y + 4));
                if (value == 1){
                    return 1;
                } else if (value == 2){
                    return 2;
        ...
        for (int x = 0; x < width - 4; ++x){
            for (int y = 0; y < height - 4; ++y){
                value = this.checkPlaces(new Point2D.Double(x,y + 4), new Point2D.Double(x + 1,y + 3), new Point2D.Double(x + 2,y + 2), new Point2D.Double(x + 3,y + 1), new Point2D.Double(x + 4,y + 0));
                if (value == 1){
                    return 1;
                } else if (value == 2){
                    return 2;
